...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Local Bus Management System</title>
	<!-- end: Meta -->
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="dashboard.php"><span>Local Bus Management System</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					...
					<?php } ?>
						...
						<li><a href="report.php"><i class="halflings-icon list white"></i><span class="hidden-tablet"> Manage Schedule</span></a></li>
